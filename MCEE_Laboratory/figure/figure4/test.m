...
for i = 1:len
    ...
    hold on
    rectangle('Position',[x,y,width,height],'LineWidth',3,'EdgeColor','r');%给原截取区域框出来
    hold on
%     rectangle('Position',[200,280,300,150],'LineWidth',2,'EdgeColor','r');%给原截取区域框出来
    hold on    
    rectangle('Position',[star_y,star_x,roi_ratio*width,roi_ratio*height],'LineWidth',3,'EdgeColor','r');%给新放置区域框出来
